...
class SentinelEventExport implements FromView
{
...
$data = Incident::where([['headrm_sendto_headdivision_status','Y'],['headrm_delete','=',''],['incident_case_id','=','["2"]']]);
      ...
      return view('reports.sentinelevent.export')->with('data',$data);
