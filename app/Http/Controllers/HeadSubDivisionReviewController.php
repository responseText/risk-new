...
class HeadSubDivisionReviewController extends Controller
{
    ...
    if( in_array('5',$arr_user_level) )
    {
      ...
      $data               =   Incident::where([
                            ...
                            $data =  $data->get();
                             ...
                             return view('headsubdivisionreview.index')
  ...
  //dd($arr_subdivision);
      if( in_array('1',$arr_user_level) || in_array('2',$arr_user_level)  || in_array('5',$arr_user_level)  )
      {
        ...
        $data               =   Incident::where([
                                ...
                                //if(   ( Auth::user()->level_id == 1 ) ||  ( Auth::user()->level_id == 2 ))
                                /*
                                if( in_array('1',$arr_user_level) || in_array('1',$arr_user_level))
                                {
                                  if( !empty($request->input('filter-division')))
                                  {
                                        foreach( $request->input('filter-division') as $k )
                  ...
                  return view('headsubdivisionreview.list')
                    ->with('evaluation',$evaluation)
                    ->with('data' , $data )
                    ->with('titlename',$titlename)
                    ->with('arr_subdivision',$arr_subdivision)
    ...
    if(in_array('1',$arr_user_level) ||   in_array('2',$arr_user_level)  || in_array('5',$arr_user_level) )
    {
      ...
      $data               =   Incident::where([
        ...
        if( in_array('5',$arr_user_level))
        {
          ...
          return view('headsubdivisionreview.create')
            ->with( 'data' , $data )
  ...
  public function update(Request $request, $id)
  {
      ...
      $myObj = Incident::where('id', $id)
            ...
            return redirect()
                    ->action('HeadSubDivisionReviewController@show',$id )
  ...
  public function sendbackrm(Request $request)
  {
    ...
    ->update([
      ...
      return redirect()
              ->action('HeadSubDivisionReviewController@index' );
  }
