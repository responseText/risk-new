...
class RMDivisionReviewController extends Controller
{
...
// dd(Session::get('user.session_division'));
   ...
   {
     return view('rmdivisionreview.index')
       ->with( 'data' , $data )
...
/*
  ...
  public function list(Request $request)
  {
    ...
    if( in_array('7',$arr_user_level) )
    {
      return view('rmdivisionreview.index1')
        ->with( 'data' , $data )
        ->with('division',$division)
        ->with('request_division', $request->input('filter-division') )
        ->with('arr_division',$arr_division)
  ...
  public function show($id)
  {
    ...
    if( count(Auth::user()->user_level)>0 )
    {
      ...
      return view('rmdivisionreview.show')
        ->with( 'data' , $data )
        ->with('arr_division',$arr_division)
  ...
  public function show1($id)
  {
      ...
      return view('rmdivisionreview.show1')
        ->with( 'data' , $data )
        ->with('rs_incidentcase',$rs_incidentcase)
        ->with('arr_subdivision',$arr_subdivision)
        ->with('rs_division',$rs_division)
  ...
  public function show2($id)
  {
      ...
      return view('rmdivisionreview.show2')
        ->with( 'data' , $data )
        ->with('titlename' , $titlename)
        ->with('rs_incidentcase',$rs_incidentcase)
        ->with('arr_subdivision',$arr_subdivision)
  ...
  public function showtorm($id)
  {
      ...
      return view('rmdivisionreview.showtorm')
        ->with( 'data' , $data )
        ->with('rs_division',$rs_division)
        ->with('rs_typerisk',$rs_typerisk);
  }
  ...
  public function sendbackrm(Request $request)
  {
    ...
    ->update([
      ...
      return redirect()
              ->action('RMDivisionReviewController@index' );
  }
  //---------------------------------------------------------------------------
  ...
  public function update(Request $request, $id)
  {
      ...
      $myObj = Incident::where('id', $id)
            ...
            return redirect()
                    ->action('RMDivisionReviewController@show2',$id )
