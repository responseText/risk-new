...
use App\Exports\NearMissExport;
class NearMissController extends Controller
{
  public function index(Request $request)
  {
    ...
    if(isset($request->filterdaterage))
    {
      ...
      return view('reports.nearmiss.index')
  ...
  public function show($id)
  {
    ...
    return view('reports.nearmiss.show')
  ...
  public function exportExcel($division,$subdivision,$originaldate)
  {
    ...
    return Excel::download(new NearMissExport($division,$subdivision,$originaldate), 'ความเสี่ยง NearMiss ที่เกิดขึ้นแยกหน่วยงาน.xlsx' );
