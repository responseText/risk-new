...
class GeneralController extends Controller
{
  public function index(Request $request)
  {
    ...
    if(isset($request->filterdaterage))
    {
      ...
      return view('reports.general.index')
  ...
  public function exportExcel($division,$subdivision,$originaldate)
  {
    ...
    return Excel::download(new GeneralExport($division,$subdivision,$originaldate), 'ความเสี่ยงอบัติการณ์ทั่วไป.xlsx' );
