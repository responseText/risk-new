...
<div class="box">
  <div class="box-header">
    <h3 class="box-title">ความเสี่ยงจากทีผ่านการคัดกรองของหัวหน้างาน </h3>
  </div>
  <!-- /.box-header -->

  <div class="box-body">
<form id="myFormSearch" class="" action="{{route('headrmreview.search')}}" method="post">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
        ...
        <table id="example2" class="table table-bordered table-hover table-responsive display nowrap"  style="width:100%" >
                ...
                <tr class="<?=$class?>">
                  ...
                  <td>
                    <a href="<?=route('headrmreview.create',[$rs->id])?>" >
                  ...
                  <td class="text-center">
                      <a href="{{route('headrmreview.show',$rs->id)}}"><i class="fa fa-filter"></i></a>
                  </td>
