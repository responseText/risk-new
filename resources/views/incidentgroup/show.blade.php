...
@section('title','รายละเอียดหมวดหมู่อุบัติการณ์' )
@section('content')
...
<div class="box">
  <div class="box-header">
    <h3 class="box-title"> <?php echo trans('buttons.info');?>หมวดหมู่อุบัติการณ์ </h3>
  </div>
  <!-- /.box-header -->
  ...
  <div class="box-body">
    ...
    <div class="row ">
      <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 col-label-show " >
        <strong>โปรแกรมความเสี่ยง</strong>
      </div>
      <div class="col-lg-10  col-md-9 col-sm-8 col-xs-12">
        <p class="text-muted">
          <?php echo $data->risk_program->name;?>
        </p>
      </div>
    </div>
  ...
  <div class="box-footer">
    ...
    {
    ?>
    <a href="{{action('IncidentGroupController@edit',$data->id)}}" class="btn btn-primary pull-right">
