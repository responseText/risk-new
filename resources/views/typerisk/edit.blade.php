...
@section('title','ประเภทความเสี่ยง' )
@section('content')
@include('layouts/function')
<form class="form-horizontal" action="{{route('typerisk.update',[ $data->id ])}}"  method="post">
...
<div class="box">
  <div class="box-header">
    <h3 class="box-title"><?php echo trans('buttons.edit');?>ประเภทความเสี่ยง </h3>
  </div>
  <!-- /.box-header -->
