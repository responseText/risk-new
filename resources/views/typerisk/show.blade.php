...
@section('title','รายละเอียดประเภทความเสี่ยง' )
@section('content')
...
<div class="box">
  <div class="box-header">
    <h3 class="box-title"> <?php echo trans('buttons.info');?>ประเภทความเสี่ยง </h3>
  </div>
  <!-- /.box-header -->
  ...
  <div class="box-footer">
    ...
    {
    ?>
    <a href="{{action('TypeRiskController@edit',$data->id)}}" class="btn btn-primary pull-right">
