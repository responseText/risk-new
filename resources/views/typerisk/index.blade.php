...
<div class="box">
  <div class="box-header">
    <h3 class="box-title">ข้อมูลประเภทความเสี่ยง </h3>
  </div>
  <!-- /.box-header -->
  ...
  <div class="box-body">
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
        ...
        {
        ?>
        <a href="{{route('typerisk.create')}}" class="btn btn-primary">
        ...
        <table id="example2" class="table table-bordered table-hover table-responsive" >
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="<?=route('typerisk.show',[$rs->id])?>" >
                    <?php echo $rs->name;?>
                    </a>
                  </td>
                  <td class="text-center">
...
<script type="text/javascript" src="{{asset('js/system/typerisk/js-handle.js')}}"></script>
<script>
