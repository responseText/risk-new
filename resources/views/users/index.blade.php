      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
        ...
        <table id="example2" class="table table-bordered table-hover table-responsive" >
                ...
                <tr>
                  ...
                  <th class="text-center">ผู้ใช้งานระบบ</th>
...
<?php
 if( count($data) > 0 ){
 ?>
 <form id="myStatusForm" name="myStatusForm"  action="{{action('UsersController@changestatus')}}"  method="POST" >
 <input type="hidden" name="_method" value="POST">
 <input type="hidden" name="_token" value="{{ csrf_token() }}">
...
<script type="text/javascript" src="{{asset('js/system/users/js-handle.js')}}"></script>
<script>
