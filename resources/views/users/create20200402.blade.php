...
///$('#area_division').hide();
    ...
    $('.btnAdd').click(function(event){
        ...
        $('#idTemp').append( '<div class="row r1" id="row'+i+'"><div class="col-lg-8 col-md-8 col-sm-6 col-xs-6 c1"><input type="hidden" name="checkid[]" value="'+i+'"><select id="level_access'+i+'" name="level_access'+i+'" class="form-control"><option value="">***ระดับผู้ใช้งาน***</option></select></div><div class="c1 col-lg-1 col-md-1 col-sm-6 col-xs-6" id="tagdivdelete'+i+'"><a id="btnDelete'+i+'" class="btnDelete btn btn-danger" href="javascript:void(0);">-</a></div> <div id="divDivision'+i+'" class="c1 col-lg-8 col-md-8 col-sm-6 col-xs-6 "><select id="division'+i+'" name="division'+i+'" class="form-control" style="display:none;"><option value=""></option></select></div><div class="c1 col-lg-8 col-md-8 col-sm-6 col-xs-6"><select id="subdivision'+i+'" name="subdivision'+i+'" class="form-control" style="display:none;"><option value="">***หน่วยงาน***</option></select></div> </div>');
          $.ajaxSetup({
              headers: {
