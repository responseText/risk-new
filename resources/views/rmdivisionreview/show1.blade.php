...
<div class="box">
  ...
  <div class="box-body">
      ...
      if( in_array(7,$arr_user_level) &&  in_array( $data->division_id ,$arr_division) &&  !in_array( $data->sub_division_id ,$arr_subdivision) )
      {
        $HeadDivision = true;
      }
      else
        ...
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
          <div class="box box-primary box-solid">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                  ...
                  <div class="col-lg-8 col-md-9 col-sm-6 col-xs-12">
                    <textarea name="txt_edit" rows="5" cols="100"
                    <?php if($data->headrm_review_status == 'Y' || !$HeadDivision) { echo "disabled";}else{ echo '';} ?> >{{$data->headdivision_edit}}
                      </textarea>
                  </div>
              </div>
              <div class="form-group">
                  <label class="col-lg-4 col-md-3 col-sm-6 col-xs-12 control-label">ข้อเสนอแนะ</label>
                  <div class="col-lg-8 col-md-9 col-sm-6 col-xs-12">

                    <textarea name="txt_propersal" rows="5" cols="100"
                    <?php if($data->headrm_review_status == 'Y' || !$HeadDivision) { echo "disabled";}else{ echo '';}  ?> >{{$data->headdivision_propersal}}
            ...
            <div class="box-footer">
              <a class="btn btn-default" href="{{route('rmdivisionreview.list')}}">{{trans('buttons.cancel')}}</a>
              <?php
              if($data->headrm_review_status != 'Y'  && $HeadDivision)
              {
              ?>
              <button class="btn btn-success pull-right" type="submit"  name="btnOK">{{trans('buttons.update')}}</button>
              <?php
              }
              ?>
            </div><!-- /.box-footer -->
