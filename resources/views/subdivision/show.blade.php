...
<div class="box">
  <div class="box-header">
    <h3 class="box-title"> <?php echo trans('buttons.info');?>หน่วยงาน  </h3>
  </div>
  <!-- /.box-header -->
  ...
  <div class="box-footer">
    ...
    {
    ?>
    <a href="{{action('SubDivisionController@edit',$data->id)}}" class="btn btn-primary pull-right">
