...
?>
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
        <a href="{{route('subdivision.create')}}" class="btn btn-primary">
        ...
        <table id="example2" class="table table-bordered table-hover table-responsive" >
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="<?=route('subdivision.show',[$rs->id])?>" >
                    <?php echo $rs->name;?>
                    </a>
                  </td>
                  <td>
...
<?php
 if( count($data) > 0 ){
 ?>
 <form id="myStatusForm" name="myStatusForm"  action="{{action('SubDivisionController@changestatus')}}"  method="POST" >
 <input type="hidden" name="_method" value="POST">
 <input type="hidden" name="_token" value="{{ csrf_token() }}">
...
<script type="text/javascript" src="{{asset('js/system/subdivision/js-handle.js')}}"></script>
<script>
