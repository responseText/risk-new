...
<div class="box">
  <div class="box-header">
    <h3 class="box-title">ข้อมูลระดับความรุนแรง </h3>
  </div>
  <!-- /.box-header -->
  ...
  <div class="box-body">
    ...
    <div class="row">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
        <a href="{{route('violencelevel.create')}}" class="btn btn-primary">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
        ...
        <table id="example2" class="table table-bordered table-hover table-responsive" >
                ...
                <tr>
                  ...
                  <td class="text-center">
                    <a href="<?=route('violencelevel.show',[$rs->id])?>"  >
                    <?php echo $rs->name;?>
                  ...
                  <td class="text-center">
                    <strong style="color:<?php echo $rs->color;?>"><?php echo $rs->color;?></strong>
                  </td>
                  <td class="text-center">
                    <?php
                    if( in_array('1',$arr_user_level) || in_array('2',$arr_user_level) || in_array('3',$arr_user_level) )
...
<?php
 if( count($data) > 0 ){
 ?>
 <form id="myStatusForm" name="myStatusForm"  action="{{action('ViolenceLevelController@changestatus')}}"  method="POST" >
 <input type="hidden" name="_method" value="POST">
 <input type="hidden" name="_token" value="{{ csrf_token() }}">
...
<script type="text/javascript" src="{{asset('js/system/violencelevel/js-handle.js')}}"></script>
<script>
