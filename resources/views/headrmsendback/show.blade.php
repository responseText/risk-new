  ...
  <div class="box-body">
      <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          ...
          <p class="alert alert-success fade-message">{{ Session::get('success') }}</p>
          @endif
        </div>
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <?php
      ...
      <form  class="form-horizontal"  action="<?=route('headrmsendback.updateevent')?>"  method="post">
           ...
           <div class="row">
             <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
               <div class="box box-warning box-solid">
                 <div class="box-header with-border ">
                   <h3 class="box-title">Near Miss และ Sentinal Event</h3>
                 </div>
                 <!-- /.box-header -->
                 <div class="box-body">
                   <div class="row ">
                 ...
                 <div class="box-footer">
                   ...
                   <button class="btn btn-block btn-warning pull-right" type="submit"  name="btnOK">
                     <i class="fa fa-save"></i>&nbsp;{{trans('buttons.update')}}&nbsp;Near Miss และ Sentinal Event
                   </button>
      ...
      <form  class="form-horizontal <?php if( $data->headrm_delete=='Y'){ echo 'hidden';}?>" action="{{route('headrmsendback.update',[ $data->id ])}}"  method="post">
      ...
      <div class="row">
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
          <div class="box box-success box-solid">
            ...
            <div class="box-footer">
              <a href="{{route('headrmsendback.index')}}" class="btn btn-default pull-left">
                <i class="fa fa-reply"></i>&nbsp;{{trans('buttons.cancel')}}
              </a>
