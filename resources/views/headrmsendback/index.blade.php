      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
        ...
        <table id="example2" class="table table-bordered table-hover table-responsive" >
                ...
                <tr >
                  ...
                  <td>
                    <a href="<?=route('headrmsendback.show',[$rs->id])?>" >
				  ...
				  ?></td>
                  <td class="text-center">
                      <a href="{{route('headrmsendback.show',$rs->id)}}"><i class="fa fa-mail-forward"></i></a>
                  </td>
...
<script type="text/javascript" src="{{asset('js/system/headrmsendback/js-handle.js')}}"></script>
<script>
