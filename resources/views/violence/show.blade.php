...
@section('title','รายละเอียดความรุนแรง' )
@section('content')
...
<div class="box">
  <div class="box-header">
    <h3 class="box-title"> <?php echo trans('buttons.info');?>ความรุนแรง </h3>
  </div>
  <!-- /.box-header -->
  ...
  <div class="box-body">
    ...
    <div class="row ">
      ...
      <div class="col-lg-10  col-md-9 col-sm-8 col-xs-12">
        ...
        <?php echo  $data->violence_level->name;?>
        </p>
      </div>
    </div>
    <div class="row ">
  ...
  <div class="box-footer">
    ...
    {
    ?>
    <a href="{{action('ViolenceController@edit',$data->id)}}" class="btn btn-primary pull-right">
