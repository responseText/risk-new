...
@section('title','รายละเอียดอุบัติการณ์' )
@section('content')
...
<div class="box">
  <div class="box-header">
    <h3 class="box-title"> <?php echo trans('buttons.info');?>อุบัติการณ์ </h3>
  </div>
  <!-- /.box-header -->
  ...
  <div class="box-footer">
    ...
    {
    ?>
    <a href="{{action('IncidentListController@edit',$data->id)}}" class="btn btn-primary pull-right">
