...
@section('title','ข้อมูลรายการอุบัติการณ์' )
@section('content')
@include('layouts/function')
<form class="form-horizontal" action="{{route('incidentlist.store')}}"  method="post">
...
<div class="box">
  <div class="box-header">
    <h3 class="box-title"><?php echo trans('buttons.edit');?>ข้อมูลรายการอุบัติการณ์ </h3>
  </div>
  <!-- /.box-header -->
  ...
  <div class="box-body">
        ...
        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
            <label class="col-lg-3 col-md-3 col-sm-6 col-xs-12 control-label">อุบัติการณ์</label>
