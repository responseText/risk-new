...
<div class="box">
  ...
  <div class="box-body">
    ...
    <form id="myFormSearch" class="" action="{{route('headdivisionreview.list')}}" method="post">
        ...
        <table id="example2" class="table table-bordered table-hover table-responsive display nowrap" style="width:100%">
                ...
                else
                {
                  ...
                  <td>
                    ...
                    <a href="<?=route('headdivisionreview.show2',[$rs->id])?>" >
                  ...
                  <td class="text-center">
                      <a href="{{route('headdivisionreview.show2',[$rs->id])}}"><i class="fa fa-mail-forward"></i></a>
                  </td>
                    ...
                    elseif( in_array('4',$arr_user_level) )
                    {
                      // code...
...
<script type="text/javascript" src="{{asset('js/system/headdivisionreview/js-handle0.js')}}"></script>
<script>
