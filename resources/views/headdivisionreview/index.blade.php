      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="box box-info">
            ...
            <div class="box-footer">
              ...
              <a href="{{route('headdivisionreview.index')}}" class="btn btn-default">ล้าง</a>
        ...
        <table id="example2" class="table table-bordered table-hover table-responsive  display nowrap"  style="width:100%" >
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="<?=route('headdivisionreview.show',[$rs->id])?>" >
                  ...
                  <td class="text-center">
                      <a href="{{route('headdivisionreview.show',$rs->id)}}"><i class="fa fa-mail-forward"></i></a>
                  </td>
...
if($nameRoute =="headdivisionreview.index")
{
?>
...
?>
<script type="text/javascript" src="{{asset('js/system/headdivisionreview/js-handle1.js')}}"></script>
<?php
}
?>
