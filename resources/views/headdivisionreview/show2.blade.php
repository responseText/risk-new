...
<div class="box">
  <div class="box-header">
    <h3 class="box-title"> <?php echo trans('buttons.info');?>ความเสี่ยงของหน่วยงานที่ได้รับ :<?=$titlename?>
        ...
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
          <div class="box box-success box-solid">
            ...
            <div class="box-footer">
              ...
              {
              ?>
              <a class="btn btn-primary pull-right" href="{{route('headdivisionreview.show1',$data->id)}}">{{trans('buttons.edit')}}</a>
              <?php
              }
              ?>
            </div><!-- /.box-footer -->
