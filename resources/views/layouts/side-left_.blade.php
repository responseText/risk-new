      ...
      ?>
        ...
        <li class="treeview menu-open">
          ...
          <ul class="treeview-menu" style="display: block;" >
            ...
            <li><a href="{{route('incident.index')}}"><i class="fa f fa-info"></i>อุบัติการณ์ความเสี่ยง</a></li>

            <li><a href="{{route('incident.create')}}"><i class="fa fa-pencil-square-o"></i>เขียนความเสี่ยง</a></li>
        ...
        <li class="treeview menu-open">
          ...
          <ul class="treeview-menu" style="display: block;" >
              <li>
                <a href="{{route('headrmremove.index')}}"><i class="fa fa-th-list"></i>
                  <span>ความเสี่ยงมาใหม่</span>
                   @if(get_count_newriskForHeadRM( Auth::user() ) > 0 )
                  <span class="pull-right-container">
                    <small class="label pull-right bg-yellow">มาใหม่ {{get_count_newriskForHeadRM( Auth::user() )}} </small>
              ...
              <li>
                <a href="{{route('headrmreview.index')}}"><i class="fa fa-graduation-cap"></i> ความเสี่ยงจากหัวหน้างาน
                  <?php
                  if( get_AlereRMstep2( Auth::user() ) > 0 )
                  {
                  ?>
                  <span class="pull-right-container">
                   <small class="label pull-right bg-yellow">มาใหม่ {{get_AlereRMstep2( Auth::user() )}} </small>
              ...
              <li>
                <a href="{{route('headrmlistall.index')}}"><i class="fa fa-database"></i> ความเสี่ยงทั้งหมด
        ...
        <li class="treeview menu-open">
          ...
          <ul class="treeview-menu" style="display: block;" >
              <li>
              <a href="{{route('headdivisionreview.index')}}"><i class="fa fa-th-list"></i> <span>ความเสี่ยงมาใหม่</span>
                <?php
                if( get_count_newriskForHeadDivision( Auth::user() ) > 0 )
                {
                ?>
                <span class="pull-right-container">
                 <small class="label pull-right bg-yellow">มาใหม่ {{get_count_newriskForHeadDivision( Auth::user() )}} </small>
             ...
             <li><a href="{{route('headdivisionreview.list')}}"><i class="fa fa-tasks"></i> ความเสี่ยงของหน่วยงาน</a></li>
			 <li><a href="{{route('usersindepreport.index')}}"><i class="fa fa-tasks"></i> ความเสี่ยงโดยเจ้าหน้าทีฝ่าย</a></li>
		  </ul>
        </li>
        ...
        <li class="treeview menu-open">
          ...
          <ul class="treeview-menu" style="display: block;" >
              <li>
              <a href="{{route('headsubdivisionreview.index')}}"><i class="fa fa-th-list"></i> <span>มีความเสี่ยงใหม่</span>
                <?php
                if( get_count_newriskForHeadSubDivision( Auth::user() ) > 0 )
                {
                ?>
                <span class="pull-right-container">
                 <small class="label pull-right bg-yellow">มาใหม่ {{get_count_newriskForHeadSubDivision( Auth::user() )}} </small>
              ...
              <li><a href="{{route('headsubdivisionreview.list')}}"><i class="fa fa-tasks"></i> ความเสี่ยงของหน่วยงาน</a></li>
			  <li><a href="{{route('usersinsubdivisionreport.index')}}"><i class="fa fa-tasks"></i> ความเสี่ยงเจ้าหน้าที่หน่วยงาน</a></li>>
          </ul>
        </li>
