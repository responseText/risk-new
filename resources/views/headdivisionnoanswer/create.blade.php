...
<div class="box">
  ...
  <div class="box-body">
      ...
      <form class="form-horizontal" action="{{route('headdivisionnoanswer.update',[$data->id])}}" id="myForm" method="post">
        ...
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
          <div class="box box-success box-solid">
            ...
            <div class="box-body">
              ...
              {
                $input_txt_edit       = $data->headrm_review_edit;
                $input_txt_propersal  = $data->headrm_review_propersal;
                $input_evaluation     = $data->incident_status_id;
              }
              else
              {
                $input_txt_edit =old('txt_edit');
                $input_txt_propersal=old('txt_propersal');
                $input_evaluation     = old('evaluation');
              }
              ...
              <div class="form-group">
                  ...
                  <div class="col-lg-9 col-md-9 col-sm-6 col-xs-12">
                    <textarea name="txt_edit" rows="5" cols="100" >{{$input_txt_edit}}</textarea>
                  </div>
              </div>
              <div class="form-group">
                  <label class="col-lg-3 col-md-3 col-sm-6 col-xs-12 control-label">ข้อเสนอแนะ</label>
                  <div class="col-lg-9 col-md-9 col-sm-6 col-xs-12">
                    <textarea name="txt_propersal" rows="5" cols="100">{{$input_txt_propersal}}</textarea>
                  </div>
              </div>
              ...
              <div class="form-group  {{ $errors->has('evaluation') ? ' has-error' : '' }}">
                  ...
                  <div class="col-lg-9 col-md-9 col-sm-6 col-xs-12">
                    <select id="evaluation" name="evaluation" class="select2 form-control">
                        ...
                        {
                        ?>
                        <option value="{{$rs->id}}" <?php if($rs->id == $input_evaluation){echo 'selected="selected"';}?>>{{$rs->name}}</option>
