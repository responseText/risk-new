  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="box">
      ...
      <div class="box-body">
        ...
        <form id="myFormSearch" class="" action="{{route('headsubdivisionreview.list')}}" method="post">
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="box box-info">
                ...
                <div class="box-footer">
                  <a href="{{route('headsubdivisionreview.list')}}" class="btn btn-default" >ล้าง</a>
            ...
            <table id="example2" class="table table-bordered table-hover table-responsive display nowrap"  style="width:100%">
              ...
              <tbody>
                ...
                <tr class="<?=$mystyleTR?>">
                  ...
                  <td>
                    <a href="<?=route('headsubdivisionreview.show',[$rs->id])?>" >
                    <?php
                  ...
                  <td class='text-center'>
                    <a href="{{route('headsubdivisionreview.show',[$rs->id])}}"><i class="fa  fa-commenting-o"></i></a>
                  </td>
...
<script type="text/javascript" src="{{asset('js/system/headsubdivisionreview/js-handle1.js')}}"></script>
<script>
$(function () {
  $('.select2').select2();
