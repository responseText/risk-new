...
<div class="box">
  ...
  <div class="box-body">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
          <div class="box box-warning box-solid">
            ...
            <div class="box-body">
              ...
              <div class="row ">
                <div class="col-lg-4 col-md-5 col-sm-5 col-xs-12 col-label-show " >
                <strong>Near Miss && Sentinel Event </strong>
                </div>
                <div class="col-lg-8  col-md-7 col-sm-7 col-xs-12">
      ...
      <form class="form-horizontal" action="{{route('headsubdivisionreview.update',[ $data->id ])}}"  method="post">
        ...
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
          <div class="box box-warning box-solid">
            ...
            <div class="box-body">
              ...
              <div class="form-group">
                  ...
                  <div class="col-lg-9 col-md-9 col-sm-6 col-xs-12">
                    ...
                    <?php if($data->headrm_review_status == 'Y') { echo "disabled";} ?> >{{$data->headdivision_edit}}
                      </textarea>
                  </div>
              </div>
              <div class="form-group">
                  ...
                  <div class="col-lg-9 col-md-9 col-sm-6 col-xs-12">
                    ...
                    <?php if($data->headrm_review_status == 'Y') { echo "disabled";} ?> >{{$data->headdivision_propersal}}
            ...
            <div class="box-footer">
              <a class="btn btn-default" href="{{route('headsubdivisionreview.list')}}">{{trans('buttons.cancel')}}</a>
              <?php
...
<script type="text/javascript" src="{{asset('js/system/headsubdivisionreview/js-handle.js')}}"></script>
