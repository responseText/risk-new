...
<div class="box">
  ...
  <div class="box-body">
    ...
    <form id="myFormSearch" class="" action="{{route('headsubdivisionreview.search')}}" method="post">
      ...
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
        ...
        <table id="example2" class="table table-bordered table-hover table-responsive display nowrap"  style="width:100%" >
                ...
                //  if( ( ( $rs->division_id == Auth::user()->division_id ) &&  Auth::user()->level_id == '4') || Auth::user()->level_id == '1' || Auth::user()->level_id == '2' || ($rs->division_id == 0)  )
                   ...
                   if( in_array($rs->sub_division_id, $arr_subdivision)  && in_array('5',$arr_user_level)  )
                   {
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <a href="<?=route('headsubdivisionreview.create',[$rs->id])?>" >
                  ...
                  <td class="text-center">
                      <a href="{{route('headsubdivisionreview.create',$rs->id)}}"><i class="fa fa-mail-forward"></i></a>
                  </td>
