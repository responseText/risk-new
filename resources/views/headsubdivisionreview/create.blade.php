...
<div class="box">
  ...
  <div class="box-body">
      ...
      <form id ="myForm"class="form-horizontal" action="{{route('headsubdivisionreview.update',[ $data->id ])}}"  method="post">
        ...
        <div class="col-lg-12 col-md-12 col-xs-12 col-sm-12">
          <div class="box box-info box-solid">
            ...
            <div class="box-footer">
              <a href="{{route('headsubdivisionreview.index')}}" class="btn btn-default">{{trans('buttons.cancel')}}</a>
  ...
  <div class="modal-dialog" role="document">
    ...
    <h4>คุณต้องการจะส่งคืนความเสี่ยงให้คณะกรรมการ  เพื่อตรวจสอบอีกครั้งว่าเป็นความเสี่ยงของหน่วยงานที่เรารับผิดชอบหรือไม่</h4>
      ...
      <div class="modal-footer">
        <form id="myFormSendback" action="{{route('headsubdivisionreview.sendbackrm')}}" method="post">
