...
-->
  ...
  <?php
//echo $data_title[0]->RiskProgramName
  ?>
  <div class="row">
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="box box-primary">
          ...
          <div class="box-body">
            <h4><?=$data_title[0]->RiskProgramName?>&nbsp;&nbsp;::&nbsp;หมวด&nbsp;<?=$data_title[0]->IncidentGroupName?></h4>
            <h5>ระดับความรุนแรง : <?php echo $data_violence->code." ".$data_violence->name; ?></h5>
            <hr>
