          ...
          <div class="box box-info box-solid">
            ...
            <div class="box-body">
              <dl class="dl-horizontal">
                <dt>การแก้ไข</dt>
                <dd>
                  <?php if($data->headdivision_edit =='' || empty($data->headdivision_edit) ) { echo '-';}else{ echo $data->headdivision_edit;} ?>
                </dd>
                <dt>ข้อเสนอแนะ</dt>

                <dd>
                  <?php if($data->headdivision_propersal =='' || empty($data->headdivision_propersal) ) { echo '-';}else{ echo $data->headdivision_propersal;} ?>
          ...
          <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <div class="box box-success box-solid">
              ...
              <div class="box-body">
                <dl class="dl-horizontal">
                  <dt>การแก้ไข</dt>
                  <dd><?php if($data->headrm_review_edit =='' || empty($data->headrm_review_edit) ) { echo '-';}else{ echo $data->headrm_review_edit;} ?></dd>
                  <dt>ข้อเสนอแนะ</dt>
                  <dd><?php if($data->headrm_review_propersal =='' || empty($data->headrm_review_propersal) ) { echo '-';}else{ echo $data->headrm_review_propersal;} ?>
