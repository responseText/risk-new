    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <form action="{{route('reports.sentinelevent')}}" method="POST">
...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <div class="box box-primary">
      <div class="box-body">
        <h4>รายงานความเสี่ยงแบบ  Sentinel Event ที่เกิดขึ้นแยกหน่วยงาน</h4>
      </div>
    </div>
  </div>
</div>
        ...
        <div class="btn-group pull-right">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="javascript:print_preview();"><i class="fa fa-print"></i>พิมพ์</a></li>
              <li><a href="sentinelevent/exportExcel/<?=$division_id?>/<?=$urlsubdivision?>/<?=$urlse_date?>"><i class="fa fa-file-excel-o"></i>ส่งออก EXCEL</a></li>
        ...
        <table id="datatable" class="table table-bordered table-hover table-responsive display nowrap"  style="width:100%" >
          <thead>
            <tr class="table-primary text-center">
              <th class="text-center" width="10%">วันที่เกิด</th>
              <th class="text-center" width="10%">ระดับ</th>
              <th class="text-center" width="20%">ชื่อเหตุการณ์</th>
              <th class="text-center" width="20%">รายละอียด</th>
              <th class="text-center" width="20%">การจัดการเบื้องต้น</th>
              <th class="text-center" width="20%">RM Comment</th>
            </tr>
            ...
            <tr>
              ...
              <td>
                <?php
                  ...
                  {
                  ?>
                  <a href="{{route('reports.sentinelevent.show',array( $rs->id))}}" target="_blank">
                  <?php
...
$(function () {
  ...
  if(division_id != '' || division_id !== 'undefined')
  {
    ...
    $.get('{{ url('reports/sentinelevent') }}/getsubdivision/'+division_id , function(data) {
      $('#subdivision')
          .empty()
