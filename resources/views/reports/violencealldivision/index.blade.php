    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <form action="{{route('reports.violencealldivision')}}" method="POST">
...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <div class="box box-primary">
      <div class="box-body">
        รายงานสรุปจำนวนอุบัติการณ์ แยกตามความรุนแรง (รวมทุกหน่วย)
      </div>
    </div>
  </div>
</div>
      ...
      <div class="btn-group pull-right">
        ...
        <ul class="dropdown-menu" role="menu">
          <li><a href="javascript:print_preview();"><i class="fa fa-print"></i>พิมพ์</a></li>
            <li><a href="violencealldivision/exportExcel/<?=$urlse_date?>"><i class="fa fa-file-excel-o"></i>ส่งออก EXCEL</a></li>
