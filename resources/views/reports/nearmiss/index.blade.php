    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <form action="{{route('reports.nearmiss')}}" method="POST">
...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <div class="box box-primary">
      <div class="box-body">
        รายงานความเสี่ยง Near Miss ที่เกิดขึ้นแยกหน่วยงาน
      </div>
    </div>
  </div>
</div>
        ...
        <div class="btn-group pull-right">
          ...
          <ul class="dropdown-menu" role="menu">
            <li><a href="javascript:print_preview();"><i class="fa fa-print"></i>พิมพ์</a></li>
              <li><a href="nearmiss/exportExcel/<?=$division_id?>/<?=$urlsubdivision?>/<?=$urlse_date?>"><i class="fa fa-file-excel-o"></i>ส่งออก EXCEL</a></li>
            ...
            <tr>
              ...
              <td>
                <?php
                  ...
                  {
                  ?>
                  <a href="{{route('reports.nearmiss.show',array( $rs->id))}}" target="_blank">
                  <?php
...
$(function () {
  ...
  if(division_id != '' || division_id !== 'undefined')
  {
    ...
    $.get('{{ url('reports/nearmiss') }}/getsubdivision/'+division_id , function(data) {
      $('#subdivision')
          .empty()
