    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <form action="{{route('reports.rca')}}" method="POST">
            ...
            <tr>
              ...
              <td>
                <?php
                  ...
                  {
                  ?>
                  <a href="{{route('reports.rca.show',array( $rs->id))}}" target="_blank">
                  <?php
...
$(function () {
  ...
  if(division_id != '' || division_id !== 'undefined')
  {
    ...
    $.get('{{ url('reports/rca') }}/getsubdivision/'+division_id , function(data) {
      $('#subdivision')
          .empty()
