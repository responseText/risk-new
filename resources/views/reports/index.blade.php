...
<div class="row">
    ...
    <div class="box-body table-hover table-responsive no-padding">
      ...
      -->
        ...
        <tr>
          <td>
            <a href="{{route('reports.divisiononreport')}}">รายงานกลุ่มงานที่ได้รับการรายงานอุบัติการณ์สูงสุด <span class="text-red"><strong>( *** ถูกเขียนถึง *** )</strong></span></a>
        ...
        <tr>
          <td>
            <a href="{{route('reports.divisionsendreport')}}"><s>รายงานหน่วยงานที่รายงานอุบัติการณ์สูงสุด</s><span class="text-red "><strong>( *** รอการแก้ไข *** )</strong></span></a>
      ...
      -->
        ...
        <tr>
          <td>
            <a href="{{route('reports.general')}}">รายงานความเสี่ยงอุบัติการณ์ ทั่วไป &nbsp; <b class="text-muted">( *** ไม่ใช่ Near Miss และ Sentinel Event *** )<b/></a>
        ...
        <tr>
          <td>
            <a href="{{route('reports.riskprogram')}}">รายงานสรุปจำนวนอุบัติการณ์ตามโปรแกรมความเสี่ยง </a>
