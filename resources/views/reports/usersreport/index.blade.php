    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
      ...
      <div class="box box-primary">
        ...
        <div class="box-body">
          ...
          <form action="{{route('reports.usersreport')}}" method="POST">
...
<div class="row">
  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <div class="box box-primary">
      <div class="box-body">
        รายงานเจ้าหน้าที่ที่มีการรายงานอุบัติการณ์สูงสุด
      </div>
    </div>
  </div>
</div>
      ...
      <div class="btn-group pull-right">
        ...
        <ul class="dropdown-menu" role="menu">
          <li><a href="javascript:print_preview();"><i class="fa fa-print"></i>พิมพ์</a></li>
            <li><a href="usersreport/exportExcel/<?=$urlse_date?>"><i class="fa fa-file-excel-o"></i>ส่งออก EXCEL</a></li>
        ...
        <table id="datatable" class="table table-bordered table-hover table-responsive display nowrap"  style="width:100%" >
          <thead>
            <tr class="table-primary  bg-primary text-center">
              <th class="text-center" width="90%">เจ้าหน้าที่</th>
          ...
          ?>
            <tr>
              <td width="90%">
                <?php echo $rs->prefix_name; ?><?php echo $rs->fname; ?>&nbsp;&nbsp;  <?php echo $rs->lname; ?>
              </td>
              <td width="10%"  >
                <?php echo $rs->Count; ?>
              </td>
