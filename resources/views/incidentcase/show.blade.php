...
@section('title','รายละเอียดแน้วโน้มจะเกิดความเสี่ยง' )
@section('content')
...
<div class="box">
  <div class="box-header">
    <h3 class="box-title"> <?php echo trans('buttons.info');?>แน้วโน้มจะเกิดความเสี่ยง </h3>
  </div>
  <!-- /.box-header -->
  ...
  <div class="box-body">
    ...
    <div class="row ">
      <div class="col-lg-2 col-md-3 col-sm-4 col-xs-12 col-label-show " >
        <strong>แน้วโน้มจะเกิดความเสี่ยง</strong>
      </div>
  ...
  <div class="box-footer">
    ...
    {
    ?>
    <a href="{{action('IncidentCaseController@edit',$data->id)}}" class="btn btn-primary pull-right">
