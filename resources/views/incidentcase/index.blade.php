...
@section('title','แน้วโน้มจะเกิดความเสี่ยง' )
@section('content')
...
<div class="box">
  <div class="box-header">
    <h3 class="box-title">แน้วโน้มจะเกิดความเสี่ยง </h3>
  </div>
  <!-- /.box-header -->
  ...
  <div class="box-body">
    ...
    <div class="row">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 ">
        ...
        {
        ?>
        <a href="{{route('incidentcase.create')}}" class="btn btn-primary">
        ...
        <table id="example2" class="table table-bordered table-hover table-responsive" >
                ...
                <tr >
                  ...
                  <td>
                    ...
                    <a href="<?=route('incidentcase.show',[$rs->id])?>" >
                    <?php echo $rs->name;?>
                    </a>
                  </td>
                  <td class="text-center">
...
<?php
 if( count($data) > 0 ){
 ?>
 <form id="myStatusForm" name="myStatusForm"  action="{{action('IncidentCaseController@changestatus')}}"  method="POST" >
 <input type="hidden" name="_method" value="POST">
 <input type="hidden" name="_token" value="{{ csrf_token() }}">
...
<script type="text/javascript" src="{{asset('js/system/incidentcase/js-handle.js')}}"></script>
<script>
